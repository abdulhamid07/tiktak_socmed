...
const Upload = () => {
  ...
  return (
    <div className='flex w-full h-full absolute left-0 top-[70px] mb-10 pt-5 lg:pt-10 bg-[#F8F8F8] justify-center'>
      <div className='bg-white shadow-lg rounded-lg lg:h-[82vh] h-[900px] xl:w-[60%] w-[90%] flex gap-6 flex-wrap justify-center md:justify-between items-center p-14 pt-6 '>
        <div>
          <div>
            <p className='text-2xl font-bold'>Upload Video</p>
            <p className='text-md text-gray-500 mt-1'>Post a video to your account</p>
          </div>
          <div className='border-dashed rounded-lg border-4 border-gray-200 flex flex-col justify-center items-center outline-none mt-10 w-[260px] h-[460px] p-10 cursor-pointer hover:bg-gray-100 hover:border-red-300'>
            {isLoading ? (
              <p>Uploading...</p>
            ) : (
              <div>
